...
% f2fp                = @(m,bits) floor(m * 2^bits);
% nfractionbits       = 12;
% gcfixedpoint        = ss(f2fp(control.A,nfractionbits),...
%                          f2fp(control.B,nfractionbits),...
%                          f2fp(control.C,nfractionbits),...
%                          f2fp(control.D,nfractionbits));
% state_space_to_ccode_fixed_point(gcfixedpoint,'controller',nfractionbits);